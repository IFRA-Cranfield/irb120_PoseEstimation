...
CUBES["WhiteCube"] = {"x": 0.0, "y": 0.0, "z": 0.0, "qx": 0.0, "qy": 0.0, "qz": 0.0, "qw": 0.0}
CUBES["White"] = {"x": 0.0, "y": 0.0, "z": 0.0, "qx": 0.0, "qy": 0.0, "qz": 0.0, "qw": 0.0}
...
class MoveCLIENT(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("(/Move)-Gripper: Initialising ROS2 Action Client!")
        self.get_logger().info("(/Move)-Gripper: Waiting for /Move ROS2 ActionServer to be available...")
        self._action_client.wait_for_server()
        self.get_logger().info("(/Move)-Gripper: /Move ACTION SERVER detected.")
    ...
    def goal_response_callback(self, future):
        ...
        if not goal_handle.accepted:
            self.get_logger().info('(/Move)-Gripper: Move ACTION CALL -> GOAL has been REJECTED.')
            return
...
class GzGripper():
    ...
    def CLOSE(self):
        ...
        if AttachCheck:
            ...
            print("(GzGripper): Gripper closed, object->" + str(OBJ.objectname) + " not attached.")
